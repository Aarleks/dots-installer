...
# This is Alex Norman's fork of Luke Smith's Auto Rice Boostrapping Script (LARBS)
# by Luke Smith <luke@lukesmith.xyz>
# I have changed very little apart from the the relevant addresses. Props to Luke for a well made installer script.
# License: GNU GPLv3
...
# TO RUN
# curl -LO https://raw.githubusercontent.com/Aarleks/dotfiles/master/strappyboot.sh
# bash stappyboot.sh
...
# DEFAULTS:
[ -z ${dotfilesrepo+x} ] && dotfilesrepo="https://github.com/Aarleks/configdump.git"
[ -z ${progsfile+x} ] && progsfile="https://raw.githubusercontent.com/Aarleks/dotfiles/master/programs.csv"
...
usercheck() { \
	...
	will \\Zbnot\\Zn overwrite your user files, documents, videos, etc., so don't worry about that, but only click <CONTINUE> if you don't mind your settings being overwritten.\\n\\nNote also that LARBS will change $name's password to the one you just gave." 14 70
	}
